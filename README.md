...
Проект устроен как маленькое ядро с понятными extension points. Другие пользователи могут добавлять свои storage, discovery, transport, channel, UI и QR модули через общий `ModuleRegistry`.
